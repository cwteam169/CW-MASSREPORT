...
async def handle_start(bot:Client, message:Message):
    ...
    Btn = [
        ...
        [InlineKeyboardButton(text='🌷 Uᴘᴅᴀᴛᴇs 🌷', url='https://t.me/ll_BRANDED_FAMILY_ll'), InlineKeyboardButton(text='🌷 Aʙᴏᴜᴛ 🌷', callback_data='about')],
        [InlineKeyboardButton(text='🌷 Dᴇᴠᴇʟᴏᴘᴇʀ 🌷', url='https://t.me/ll_SHIVANG_ll')]
        ]
